...
<body>
    ...
    <div class="content flex-grow-1" id="mainContent">
        ...
        <div class="container mt-2">
            <h2>{{ __('messages.create_personnel_title') }}</h2>
            <p>{{ __('messages.create_personnel_description') }}</p>
            ...
            <form action="{{ route('personnels.store') }}" method="POST">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">{{ __('messages.form_save') }}</button>
